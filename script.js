const translations = {
  en: {
    ...
    'hero.stat1': 'Higher payload efficiency',
    'hero.stat2': 'Aluminum and steel options',
    'hero.stat3': 'Configured for gas & oil logistics',
    'hero.overlay1Label': 'Application',
    'hero.overlay1Value': 'Silica sand / fracking',
    'hero.overlay2Label': 'Builds',
    'hero.overlay2Value': 'Aluminum / Steel',
    'hero.floatingTag': 'Built for field productivity',

    'pain.eyebrow': 'Where profitability gets lost',
    'pain.title': 'Tired of losing money to weight limits, slow unloading, or downtime?',
    'pain.text': 'In fracking, every ton matters and every delay costs money.',
    'pain.card1Title': 'Lost cycles',
    'pain.card1Text': 'Silica sand demand does not wait for equipment stuck in the shop.',
    'pain.card2Title': 'Compliance pressure',
    'pain.card2Text': 'You need units aligned with weight regulations and field requirements.',
    'pain.card3Title': 'Poor ROI',
    'pain.card3Text': 'A bad spec can reduce payload, daily trips, and long-term profitability.',
    ...
    'product.aluminum1': 'Lower trailer weight for improved payload potential',
    'product.aluminum2': 'Fast gravity unloading for silica sand applications',
    'product.aluminum3': 'Favorable material profile against corrosion',
    'product.aluminum4': 'Strong fit for intensive haul cycles',
    'product.steelBadge': 'Robust value / field durability',
    'product.steelTitle': 'Efficiency Steel Belly Dump / Sand Hopper',
    'product.steelText': 'A durable option for companies prioritizing ruggedness, structural value, and dependable daily use.',
    'product.steel1': 'Robust structure for demanding routes and yards',
    'product.steel2': 'Reliable performance for daily operation',
    'product.steel3': 'Strong commercial value at acquisition',
    'product.steel4': 'Ideal for fleets standardizing durable equipment',
    ...
    'compare.col2': 'Premium Aluminum',
    'compare.col3': 'Efficiency Steel',
    'compare.row1a': 'Payload efficiency',
    'compare.row1b': 'Higher potential due to lower tare weight',
    'compare.row1c': 'Balanced, depending on spec and route',
    'compare.row2a': 'Vehicle weight',
    'compare.row2b': 'Lower',
    'compare.row2c': 'Higher',
    'compare.row3a': 'Initial investment',
    'compare.row3b': 'Higher upfront',
    'compare.row3c': 'More accessible upfront',
    'compare.row4a': 'Ideal for',
    'compare.row4b': 'Owner-operators and fleets focused on payload and fast cycles',
    'compare.row4c': 'Companies seeking rugged value and standardization',
    'compare.row5a': 'Corrosion profile',
    'compare.row5b': 'Favorable in demanding environments',
    ...
    'inventory.text': 'Designed to make the product look premium, industrial, and trustworthy from the first scroll.',
    'inventory.counter1': 'Field-ready commercial approach',
    'inventory.counter2': 'Material options',
    'inventory.counter3': 'Productive mindset',
    ...
    'contact.text': 'Tell us what type of operation you run and we will help you evaluate the best option.',
    'contact.point1': 'Ask about aluminum or steel availability.',
    'contact.point2': 'Share your quantity, route, and application.',
    'contact.point3': 'Receive a commercial response tailored to your project.',

    'form.name': 'Full name',
    'form.company': 'Company / Fleet',
    'form.phone': 'Phone',
    'form.email': 'Email',
    'form.product': 'Product interest',
    'form.productPlaceholder': 'Select an option',
    'form.product1': 'Aluminum Belly Dump / Sand Hopper',
    'form.product2': 'Steel Belly Dump / Sand Hopper',
    'form.product3': 'I want to compare both',
    'form.profile': 'Business type',
    'form.profilePlaceholder': 'Select your profile',
    'form.profile1': 'Owner-Operator',
    'form.profile2': 'Transport Company',
    'form.profile3': 'Rental Business',
  ...
  es: {
    ...
    'hero.stat1': 'Mayor eficiencia de carga útil',
    'hero.stat2': 'Opciones en aluminio y acero',
    'hero.stat3': 'Configurados para logística de gas y petróleo',
    'hero.overlay1Label': 'Aplicación',
    'hero.overlay1Value': 'Arena sílica / fracking',
    'hero.overlay2Label': 'Construcción',
    'hero.overlay2Value': 'Aluminio / Acero',
    'hero.floatingTag': 'Diseñados para productividad en campo',

    'pain.eyebrow': 'Dónde se pierde rentabilidad',
    'pain.title': '¿Cansado de perder dinero por límites de peso, descargas lentas o tiempo muerto?',
    'pain.text': 'En fracking, cada tonelada cuenta y cada retraso cuesta dinero.',
    'pain.card1Title': 'Ciclos perdidos',
    'pain.card1Text': 'La demanda de arena sílica no espera a equipos detenidos en taller.',
    'pain.card2Title': 'Presión normativa',
    'pain.card2Text': 'Necesitas unidades alineadas con normativas de peso y exigencias de operación.',
    'pain.card3Title': 'ROI débil',
    'pain.card3Text': 'Una mala especificación puede reducir carga útil, viajes diarios y rentabilidad.',
    ...
    'product.aluminum1': 'Menor peso del remolque para mejorar el potencial de carga',
    'product.aluminum2': 'Descarga rápida por gravedad para arena sílica',
    'product.aluminum3': 'Perfil de material favorable ante corrosión',
    'product.aluminum4': 'Gran ajuste para ciclos intensivos de trabajo',
    'product.steelBadge': 'Valor robusto / durabilidad en campo',
    'product.steelTitle': 'Belly Dump / Sand Hopper Eficiencia en Acero',
    'product.steelText': 'Opción durable para empresas que priorizan robustez, valor estructural y uso diario confiable.',
    'product.steel1': 'Estructura robusta para rutas y patios exigentes',
    'product.steel2': 'Desempeño confiable para operación diaria',
    'product.steel3': 'Fuerte valor comercial en la adquisición',
    'product.steel4': 'Ideal para flotillas que buscan estandarizar equipo durable',
    ...
    'compare.col2': 'Premium Aluminio',
    'compare.col3': 'Eficiencia Acero',
    'compare.row1a': 'Eficiencia de carga',
    'compare.row1b': 'Mayor potencial por menor tara',
    'compare.row1c': 'Balanceada, según especificación y ruta',
    'compare.row2a': 'Peso vehicular',
    'compare.row2b': 'Menor',
    'compare.row2c': 'Mayor',
    'compare.row3a': 'Inversión inicial',
    'compare.row3b': 'Más alta al inicio',
    'compare.row3c': 'Más accesible al inicio',
    'compare.row4a': 'Ideal para',
    'compare.row4b': 'Hombre-camión y flotillas enfocadas en carga útil y ciclos rápidos',
    'compare.row4c': 'Empresas que buscan valor robusto y estandarización',
    'compare.row5a': 'Perfil ante corrosión',
    'compare.row5b': 'Favorable en ambientes exigentes',
    ...
    'inventory.text': 'Diseñada para que el producto se vea premium, industrial y confiable desde el primer scroll.',
    'inventory.counter1': 'Enfoque comercial listo para campo',
    'inventory.counter2': 'Opciones de material',
    'inventory.counter3': 'Mentalidad productiva',
    ...
    'contact.text': 'Cuéntanos qué tipo de operación tienes y te ayudamos a evaluar la mejor opción.',
    'contact.point1': 'Pregunta por disponibilidad en aluminio o acero.',
    'contact.point2': 'Comparte cantidad, ruta y aplicación.',
    'contact.point3': 'Recibe respuesta comercial enfocada a tu proyecto.',

    'form.name': 'Nombre completo',
    'form.company': 'Empresa / Flota',
    'form.phone': 'Teléfono',
    'form.email': 'Correo electrónico',
    'form.product': 'Interés de producto',
    'form.productPlaceholder': 'Selecciona una opción',
    'form.product1': 'Belly Dump / Sand Hopper de Aluminio',
    'form.product2': 'Belly Dump / Sand Hopper de Acero',
    'form.product3': 'Quiero comparar ambos',
    'form.profile': 'Tipo de negocio',
    'form.profilePlaceholder': 'Selecciona tu perfil',
    'form.profile1': 'Hombre-Camión',
    'form.profile2': 'Empresa de Transporte',
    'form.profile3': 'Rentista',
